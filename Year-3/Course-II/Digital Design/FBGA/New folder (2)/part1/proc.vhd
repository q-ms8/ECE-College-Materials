...
ARCHITECTURE Behavior OF proc IS
    ...
    CONSTANT zeroes          : STD_LOGIC_VECTOR(8 DOWNTO 0) := "000000000";
...
--    reset: process(Clock, Resetn)
--	 begin
--		if Resetn = '0' then(
--		 -- Registers
--    reg_0: regn PORT MAP (BusWires, Resetn, Rin(0), Clock, zeroes);
--    reg_1: regn PORT MAP (BusWires, Resetn, Rin(1), Clock,  zeroes);
--    reg_2: regn PORT MAP (BusWires, Resetn, Rin(2), Clock,  zeroes);
--    reg_3: regn PORT MAP (BusWires, Resetn, Rin(3), Clock,  zeroes);
--    reg_4: regn PORT MAP (BusWires, Resetn, Rin(4), Clock,  zeroes);
--    reg_5: regn PORT MAP (BusWires, Resetn, Rin(5), Clock,  zeroes);
--    reg_6: regn PORT MAP (BusWires, Resetn, Rin(6), Clock,  zeroes);
--    reg_7: regn PORT MAP (BusWires, Resetn, Rin(7), Clock,  zeroes);
--    reg_A: regn PORT MAP (BusWires, Resetn, Ain, Clock,  zeroes);
--    reg_IR: regn PORT MAP (DIN, Resetn, IRin, Clock,  zeroes);
--    reg_G: regn PORT MAP (Sum, Resetn, Gin, Clock,  zeroes));
--	 else(
...
--	 end process;
    ...
    BEGIN
        ...
        END CASE;
    END PROCESS;
--	 process(Clock, Resetn, r0, r1, r2, r3, r4, r5, r6, r7, G, A, BusWires, Sum, IR)
--	 begin
--	if Resetn = '0' then
--				r0 <= "000000000",
--				r1 <= "000000000",
